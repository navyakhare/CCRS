...
if(version!="-1"):
	...
	#filename=open('COLVAR_anc_'+str(version),'a')
	#for listitem in new_colvar:
	#	filename.write(str(listitem)+'\n')
	#c = a.tolist() + new_colvar.tolist()
	c=[]
	for i in a:
		c.append(i)
	for i in new_colvar:
	...
	#filename=open('COLVAR_anc_'+str(version),'w')
	#for listitem in colvar:
		#filename.write(str(listitem)+'\n')
